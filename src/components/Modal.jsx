...
const Modal = ({gastos, setGastos, gastosD, setGastosD, setNewGasto}) => {
  const ocultarModal = () => {
  ...
  return (
    <div className="absolute top-0 left-0 right-0 bottom-0 bg-custom-black">
      ...
      <FormNuevoGasto gastos={gastos} setGastos={setGastos} gastosD={gastosD} setGastosD={setGastosD} setNewGasto={setNewGasto}/>
    </div>
  );
};
